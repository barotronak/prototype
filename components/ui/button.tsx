        ...
        className={cn(
          ...
          // Variants
          {
            'bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-500 shadow-lg hover:shadow-xl':
              variant === 'primary',
            'bg-white/20 backdrop-blur-sm text-slate-900 hover:bg-white/30 border border-white/30 focus:ring-white/50':
              variant === 'secondary',
            'bg-transparent text-slate-700 hover:bg-white/20 focus:ring-slate-400':
              variant === 'ghost',
